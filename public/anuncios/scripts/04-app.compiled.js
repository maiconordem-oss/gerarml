...
function AIGenBtn({
  ...
  const [drafts, setDrafts] = React.useState(() => Object.fromEntries((promptKeys || []).map(k => [k, getPrompt(k)])));
  ...
  }, promptKeys.map(k => /*#__PURE__*/React.createElement("div", {
    key: k
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
...
function UploadZone({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, files.length === 0 ? 'Clique ou arraste as fotos aqui (até 5)' : `${files.length} foto(s) — clique para adicionar mais`), /*#__PURE__*/React.createElement("input", {
    ref: inputRef,
    type: "file",
    accept: "image/*",
    multiple: true,
    ...
    className: "drop-grid"
  }, files.map((url, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
  ...
  }, i === 0 ? 'principal' : i === 2 ? 'lifestyle' : `extra ${i}`)))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 20,
      paddingTop: 16,
    ...
    style: {
      ...
      border: `1px solid ${aiLoading ? '#FFE9A8' : '#A0E548'}`,
      borderRadius: 8,
      fontSize: 13,
      fontWeight: 500,
...
function TweaksUI({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "tw-tabs"
  }, ['imgs', 'text', 'meta'].map(id => /*#__PURE__*/React.createElement("button", {
    key: id,
    className: `tw-tab ${tab === id ? 'active' : ''}`,
    onClick: () => setTab(id)
  }, id === 'imgs' ? 'Imagens' : id === 'text' ? 'Textos' : 'Geral')))), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      overflowY: 'auto',
    ...
    onChange: v => set('p5_logo_letters', v),
    maxLength: 3
  }), /*#__PURE__*/React.createElement(Field, {
    ...
    label: `Imagem do círculo (tamanho: ${(data.p1e_spot || {}).size || 340}px)`,
    value: (data.p1e_spot || {}).img || '',
    onChange: v => set('p1e_spot', {
      ...(data.p1e_spot || {}),
      img: v
    })
  })), /*#__PURE__*/React.createElement(ImgField, {
...
function ImgField({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    busy: busy === 'chroma',
    onClick: () => apply(window.MLImgUtils.removeBgChroma, 'chroma')
  }, "Remover fundo (claro)"), /*#__PURE__*/React.createElement(ImgBtn, {
    busy: busy === 'smart',
    onClick: () => apply(window.MLImgUtils.removeBgSmart, 'smart')
  }, "Remover fundo (IA local)"), /*#__PURE__*/React.createElement(ImgBtn, {
    busy: busy === 'adj',
    onClick: () => apply(window.MLImgUtils.autoAdjust, 'adj')
  }, "Auto-ajuste"), /*#__PURE__*/React.createElement(ImgBtn, {
    busy: busy === 'lvl',
    onClick: () => apply(window.MLImgUtils.autoLevels, 'lvl')
    ...
    onClick: () => apply(window.MLImgUtils.removeBgVision, 'vision-bg')
  }), /*#__PURE__*/React.createElement(OpenAIImgBtn, {
    busy: busy === 'improve',
    icon: "\u2728",
    title: "Melhorar qualidade",
    desc: "gpt-image-1 corrige ilumina\xE7\xE3o, nitidez e cores",
    onClick: () => apply(window.MLImgUtils.improveQuality, 'improve')
  }), /*#__PURE__*/React.createElement(OpenAIImgBtn, {
    busy: busy === 'variation',
    icon: "\uD83C\uDFA8",
    title: "Gerar varia\xE7\xE3o",
    desc: "gpt-image-1 recria com fundo branco de est\xFAdio",
    onClick: () => apply(window.MLImgUtils.generateVariation, 'variation')
  }))));
}
function ImgBtn({
  children,
...
function BgSavedBanner({
  ...
  const handleClear = () => {
    ...
    const patch = {};
    BG_KEYS.forEach((k, i) => {
      patch[k] = `assets/bg-foto${i + 1}.png`;
    });
  ...
  }, cleared ? '✓ Fundos limpos' : `${savedCount} fundo(s) salvo(s) — carregam automaticamente`)), !cleared && /*#__PURE__*/React.createElement("button", {
    onClick: handleClear,
    style: {
      padding: '4px 10px',
...
function useTweakMode() {
  ...
  useEffect(() => {
    const h = e => {
      if (e.data?.type === '__activate_edit_mode') setActive(true);else if (e.data?.type === '__deactivate_edit_mode') setActive(false);
    };
...
function serializeData(data) {
  ...
  for (const [k, v] of Object.entries(data)) {
    if (typeof v === 'string' && v.startsWith('data:image') && v.length > 70000) {
      ...
      out[k] = v.map(item => item && typeof item === 'object' && item.img && item.img.length > 70000 ? {
        ...item,
        img: '__img_omitted__'
      } : item);
    } else {
...
function deserializeData(data) {
  ...
  for (const [k, v] of Object.entries(data)) {
    if (v === '__img_omitted__') {
      ...
      out[k] = v.map(item => item && typeof item === 'object' && item.img === '__img_omitted__' ? {
        ...item,
        img: ''
      } : item);
    } else {
...
async function fetchAds() {
  try {
    ...
    try {
      return JSON.parse(localStorage.getItem(LS_ADS_KEY) || '[]');
    } catch (_) {
      return [];
    }
  }
...
async function deleteAdById(id) {
  try {
    await supaFetch('DELETE', `/anuncios?id=eq.${id}`);
  } catch (_) {}
}
function AdManager({
  data,
  ...
  }, "Nenhum an\xFAncio ainda") : ads.map(ad => /*#__PURE__*/React.createElement("div", {
    key: ad.id,
    onClick: () => handleLoad(ad),
    style: {
      padding: '10px 14px',
      borderBottom: '1px solid #f3f4f6',
      cursor: 'pointer',
  ...
  }, "Apagar"))))), open && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
      inset: 0,
      zIndex: 199
...
function SlotToolbar({
  ...
  const hasImg = !!imgSrc;
  const adj = data && data[slotKey + '_adj'] || {
    brightness: 100,
    contrast: 100,
    saturation: 100
  };
  ...
  const updAdj = (k, v) => set(slotKey + '_adj', {
    ...adj,
    [k]: v
  });
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onClick: () => set(zoomKey, Math.max(0.1, zoom - 0.1)),
    style: {
      width: 22,
      height: 22,
      border: 'none',
    ...
    onClick: () => set(zoomKey, Math.min(4, zoom + 0.1)),
    style: {
      width: 22,
      height: 22,
      border: 'none',
    ...
    onClick: () => apply(window.MLImgUtils.autoAdjust, 'auto'),
    disabled: !hasImg || !!busy,
    style: BTN(busy === 'auto')
    ...
    onClick: () => apply(window.MLImgUtils.generateVariation, 'var'),
    disabled: !hasImg || !!busy,
    style: BTN(busy === 'var')
  ...
  }, "\u21BA Reset")), tab === 'txt' && /*#__PURE__*/React.createElement(React.Fragment, null, ['bold', 'italic', 'underline', 'strikeThrough'].map((cmd, i) => /*#__PURE__*/React.createElement("button", {
    key: cmd,
    onMouseDown: e => {
      e.preventDefault();
  ...
  }, [/*#__PURE__*/React.createElement("b", null, "B"), /*#__PURE__*/React.createElement("i", null, "I"), /*#__PURE__*/React.createElement("u", null, "U"), /*#__PURE__*/React.createElement("s", null, "S")][i])), /*#__PURE__*/React.createElement("div", {
    style: {
      width: 1,
      height: 18,
      background: 'rgba(255,255,255,.15)',
    ...
    onMouseDown: e => {
      e.preventDefault();
      const a = window.__mlFmtActive;
      if (!a) return;
      const sz = Math.max(8, (parseFloat(a.el.style.fontSize) || parseFloat(window.getComputedStyle(a.el).fontSize) || 32) - 8);
    ...
    onMouseDown: e => {
      ...
      const a = window.__mlFmtActive;
      if (!a) return;
      const sz = Math.min(300, (parseFloat(a.el.style.fontSize) || parseFloat(window.getComputedStyle(a.el).fontSize) || 32) + 8);
      a.el.style.fontSize = sz + 'px';
      a.onSave(a.el.innerHTML);
    },
    style: BTN(false)
