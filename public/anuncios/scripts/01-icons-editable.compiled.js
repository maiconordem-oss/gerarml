...
const I = {
  ...
  tools: p => /*#__PURE__*/React.createElement("svg", _extends({
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
    strokeWidth: "2",
  ...
  ruler: p => /*#__PURE__*/React.createElement("svg", _extends({
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
    strokeWidth: "2",
  ...
  feather: p => /*#__PURE__*/React.createElement("svg", _extends({
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
    strokeWidth: "2",
  ...
  medal: p => /*#__PURE__*/React.createElement("svg", _extends({
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
    strokeWidth: "2",
  ...
  diamond: p => /*#__PURE__*/React.createElement("svg", _extends({
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
    strokeWidth: "2",
  ...
  package: p => /*#__PURE__*/React.createElement("svg", _extends({
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
    strokeWidth: "2",
...
async function buildLocalFontEmbedCSS() {
  ...
  const blocks = await Promise.all(FONT_FILES.map(async ({
    family,
    file,
    range
  }) => {
...
async function waitForTemplateFonts() {
  if (document.fonts && document.fonts.load) {
    await Promise.all([document.fonts.load('400 24px Inter'), document.fonts.load('600 24px Inter'), document.fonts.load('700 48px Montserrat'), document.fonts.load('800 56px Montserrat')]);
  }
...
function PanZoomImg({
  ...
  const state = panKey && data && data[panKey] || {
    x: 0,
    y: 0,
    scale: 1
  };
...
function ImgAdjustBar({
  slotKey,
  data,
  set
}) {
  const adjKey = slotKey + '_adj';
  const adj = data[adjKey] || {
    brightness: 100,
    contrast: 100,
    saturation: 100
  };
  ...
  const update = (field, val) => set(adjKey, {
    ...adj,
    [field]: val
  });
  return /*#__PURE__*/React.createElement("div", {
...
function CropOverlay({
  ...
  const H = (type, pos) => /*#__PURE__*/React.createElement("div", {
...
(function loadSavedBrand() {
  try {
    const s = localStorage.getItem('gerarml_brand');
...
function BrandColorPicker() {
  ...
  }, [['Cor principal', customPrimary, setCustomPrimary], ['Acento', customAccent, setCustomAccent]].map(([label, val, setVal]) => /*#__PURE__*/React.createElement("label", {
    key: label,
    style: {
      fontSize: 11,
      fontWeight: 600,
